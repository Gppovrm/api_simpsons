...
# def delete_family(family_id: int):
#     global families_db
#     family = next((c for c in families_db if c.id == families_db), None)
#     if family is None:
#         raise HTTPException(status_code=404, detail="Family not found")
#
#     families_db = [f for f in families_db if f.id != family_id]
#     return {"message": "Family deleted", "status": 202}
#
#
