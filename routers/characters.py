...
characters_db = [
    Character(id=1, name="Homer Simpson", age=39, occupation="Nuclear Safety Inspector", catchphrase="D'oh!", family_id=1),
    ...
    Character(id=4, name="Lisa Simpson", age=8, occupation="Student", catchphrase="If anyone wants me, I'll be in my room.", family_id=1),
    ...
    Character(id=7, name="Mr. Burns", age=104, occupation="Owner of the Springfield Nuclear Power Plant", catchphrase="Excellent...", family_id=None),
    ...
    Character(id=10, name="Milhouse Van Houten", age=10, occupation="Student", catchphrase="Everything's coming up Milhouse!", family_id=None)
]
...
@router.delete("/characters/{character_id}", response_model=Character, tags=["Персонажи"], summary="Удалить персонажа")
